[![CI/CD GitHub Actions]([https://github.com/seekerk/gtest/actions/workflows/test-action.yml](https://github.com/rensffz/dev/actions/workflows/test-action.yml)/badge.svg)](https://github.com/rensffz/dev/actions/workflows/test-action.yml)
...
[![Code Smells](https://sonarcloud.io/api/project_badges/measure?project=rensffz_dev&metric=code_smells)](https://sonarcloud.io/summary/new_code?id=rensffz_dev)
